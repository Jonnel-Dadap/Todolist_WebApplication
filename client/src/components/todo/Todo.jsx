      ...
      <div className="relative mx-auto max-w-2xl overflow-hidden rounded-3xl border border-white/10 bg-[#121212] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.8)] backdrop-blur-xl sm:p-10">
        ...
        <header className="mb-10 border-b border-white/10 pb-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
  onClick={logout}
  className="rounded-lg border border-white/10 bg-[#0A0A0A] px-3.5 py-1.5 text-xs font-medium text-stone-300 transition-all hover:border-white hover:bg-white hover:text-black"
>
  Logout
</button>
          </div>
